...
public class PersonRecordDemo {
	...
	/**
	 * This is all it takes to define a record - compiler generates constructor,
	 * toString, equals/hashcode, etc. Hint: after compiling this file, do: javap
	 * 'PersonRecordDemo$Person'
	 */
