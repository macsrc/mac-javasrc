...
public class ArraysEqualsCompareToString {
	...
	public static void main(String[] args) {
		ArraysEqualsCompareToString comp = new ArraysEqualsCompareToString();
		comp.main();
	}
	...
	void main() {
		...
		char[] ca = { 'a', 'b', 'c' }, cb = { 'a', 'b', 'c' };
		System.out.println("ca = " + Arrays.toString(ca) + ", " + "cb = " + Arrays.toString(cb));
		...
		System.out.println("ia = " + Arrays.toString(ia) + " ib = " + Arrays.toString(ib));
